...
\par{Log-log barcode by UMI count knee plots showing which barcodes were determined to contain cells under the \textbf{a)} old method using 2nd derivative and the \textbf{b)} new emptydrop method (credit: 10x genomics website).}
\end{centering}
\end{figure}
